...
def fetch_failure_details():
    try:
        ...
        print(f"Error fetching failure details: {e}")
        return None
    except Exception as e:
...
def extract_sql_block_by_failure_message(sql_queries, failure_message):
    try:
        ...
        print(f"Error extracting SQL block by failure message: {e}")
        return None
...
def update_failure_ticket_details(id, ticket_key):
    try:
        ...
        print(f"Error updating failure ticket details: {e}")
    except Exception as e:
...
def handle_failure_resolution():
    try:
        ...
        print(f"Unexpected error in failure resolution: {e}")
